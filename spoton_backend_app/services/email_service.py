...
Park with ease, live in peace."""
      ...
      <div style="max-width: 520px; margin: auto; background: white; border-radius: 12px;
        ...
        <div style="padding: 28px 32px;">
          ...
          <div style="background: #f0f9fb; border-left: 4px solid #0e9aad; border-radius: 8px;
            ...
            <p style="margin: 8px 0;">🅿️ <strong>Assigned Space:</strong> {space_id}</p>
            <p style="margin: 8px 0;">⏰ <strong>Parking Time:</strong> {start_time} – {end_time}</p>
    ...
    try:
        response = ses_client.send_email(
            ...
            Destination={"ToAddresses": [recipient_email]},
            Message={
                "Subject": {"Data": "SpotOn Agent — Temporary Resident Parking Confirmation 🅿️"},
                "Body": {
                    "Text": {"Data": plain},
                    "Html": {"Data": html},
                },
...
SpotOn Agent"""
      ...
      <div style="max-width: 520px; margin: auto; background: white; border-radius: 12px;
        ...
        <div style="padding: 28px 32px;">
          ...
          <div style="background: #f0f9fb; border-left: 4px solid #0e9aad; border-radius: 8px;
            ...
            <p style="margin: 8px 0;">🚗 <strong>Vehicle:</strong> {vehicle_plate}</p>
            <p style="margin: 8px 0;">🅿️ <strong>Assigned Space:</strong> {space_id}</p>
            <p style="margin: 8px 0;">⏰ <strong>Time:</strong> {start_time} – {end_time}</p>
            <p style="margin: 8px 0;">🛠️ <strong>Reason:</strong> {reason}</p>
          </div>
    ...
    try:
        response = ses_client.send_email(
            ...
            Destination={"ToAddresses": [recipient_email]},
            Message={
                "Subject": {"Data": "SpotOn Agent — Temporary Resident Parking Notification"},
                "Body": {
                    "Text": {"Data": plain},
                    "Html": {"Data": html},
                },
